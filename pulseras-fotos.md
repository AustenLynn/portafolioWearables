...
![Tira LED NeoPixel encendida](assets/img/pulseras/electronica-tira-led-arduino-2.jpg)
*Figura 1 — Tira LED NeoPixel encendida: validación del control de iluminación desde Arduino.*

![Tira LED NeoPixel en muñeca con app](assets/img/pulseras/electronica-tira-led-muñeca.jpg)
*Figura 2 — Tira LED NeoPixel colocada en muñeca durante prueba funcional con la aplicación móvil en primer plano.*

![Arduino + breadboard (vista conexiones)](assets/img/pulseras/electronica-arduino-breadboard.jpg)
*Figura 3 — Arduino MKR WiFi con breadboard, sensor de movimiento y LED strip: prueba de integración de subsistemas.*

![Vista general del banco de trabajo electrónico](assets/img/pulseras/electronica-laboratorio-mesa.jpg)
...
![Tira LED roja encendida](assets/img/pulseras/electronica-tira-led-roja.jpg)
*Figura 5 — Tira LED encendida en rojo: prueba de patrón de retroalimentación visual.*

![Arduino con cableado y breadboard](assets/img/pulseras/electronica-arduino-conexiones.jpg)
*Figura 6 — Arduino MKR WiFi con breadboard y cableado completo durante sesión de depuración.*

![Arduino con potenciómetro en breadboard](assets/img/pulseras/electronica-arduino-potenciometro.jpg)
...
![Costura de la pulsera](assets/img/pulseras/fabricacion-costura-guante.jpg)
...
![Corte y medición de foam — 1](assets/img/pulseras/fabricacion-corte-foam-1.jpg)
*Figura 10 — Medición precisa de la banda de foam con calibrador para asegurar el ajuste correcto a la muñeca.*

![Corte y medición de foam — 2](assets/img/pulseras/fabricacion-corte-foam-2.jpg)
